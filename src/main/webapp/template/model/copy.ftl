...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="basicMessage">
        <form class="form-horizontal" id="activiti-model-copyModel-form" action="#" method="post">
            <div>
                <br/>
            </div>
            ...
            <div class="modal-footer" id="activiti-model-copyModel-btn">
                <button type="button" class="btn btn-save" onclick="activiti.model.copy.doSubmit()">复制</button>
                <button type="button" class="btn btn-cancel" onclick="activiti.model.copy.doClose()">关闭</button>
            </div>
        </form>
