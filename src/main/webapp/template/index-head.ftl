    ...
    <link rel="stylesheet" href="${contextPath}/static/css/core.css">
    <link rel="stylesheet" href="${contextPath}/static/css/navigation.css">
	<link rel="stylesheet" href="${contextPath}/static/icons/icomoon/styles.css">
	<!-- 附件上传下载 -->
	...
	<!-- 分页插件 -->
	<script type="text/javascript" src="${contextPath}/static/js/plug/pagination/bootpag.min.js"></script>
	<script type="text/javascript" src="${contextPath}/static/js/plug/pagination/bs_pagination.min.js"></script>
	<script type="text/javascript" src="${contextPath}/static/js/plug/pagination/datepaginator.min.js"></script>
